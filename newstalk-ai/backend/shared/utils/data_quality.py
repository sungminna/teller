...
from .exceptions import (
    DataValidationError, NewsTeamError, ErrorCategory, ErrorSeverity,
...
class AdvancedDataQualityManager:
    ...
    async def validate_data_quality(
        ...
        for i, record in enumerate(data_list):
            ...
            for metric in QualityMetric:
                metric_issues = [issue for issue in record_issues if issue.rule_name in self._get_rules_by_metric(metric)]
        ...
        # 개선 제안 생성
        improvement_suggestions = self._generate_improvement_suggestions(all_issues, avg_metric_scores)
            ...
            try:
                ...
                if not is_valid:
                    ...
                    issues.append(QualityIssue(
                        ...
                        sample_value=str(record.get(self._extract_field_name(rule_name), ''))[:100],
    ...
    def _validate_category_consistency(self, record: Dict) -> bool:
        ...
        valid_categories = {
            ...
            'sports', 'entertainment', 'technology', 'science',
            '정치', '경제', '사회', '국제', '스포츠', '연예', '기술', '과학'
        }
    ...
    async def get_quality_trends(self, dataset_name: str = None, days: int = 7) -> Dict[str, Any]:
        ...
        filtered_reports = [
            ...
            (dataset_name is None or report.dataset_name == dataset_name)
        ]
