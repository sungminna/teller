...
class EnhancedKafkaPublisherOperator(BaseOperator):
    ...
    async def _publish_articles(self, articles: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if self.streaming_mode:
            await publish_realtime_update('publishing_completed', {
    ...
    async def _publish_raw_news(self, articles: List[Dict[str, Any]], results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for i in range(0, len(articles), batch_size):
            ...
            for j, result in enumerate(batch_results):
                if isinstance(result, Exception):
                    ...
                    if self.streaming_mode:
                        await publish_realtime_update('article_published', {
    ...
    async def _publish_processed_news(self, articles: List[Dict[str, Any]], results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for article in articles:
            try:
                ...
                if success:
                    ...
                    if self.streaming_mode:
                        await publish_realtime_update('article_processed', {
    ...
    async def _publish_user_feedback(self, feedback_items: List[Dict[str, Any]], results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for feedback in feedback_items:
            try:
                ...
                if success:
                    ...
                    if self.streaming_mode:
                        await publish_realtime_update('feedback_received', {
                            'user_id': user_id,
    ...
    async def _publish_generic(self, items: List[Dict[str, Any]], results: Dict[str, Any]) -> Dict[str, Any]:
...
class KafkaPublisherOperator(EnhancedKafkaPublisherOperator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, **kwargs)
        logger.warning("Using legacy KafkaPublisherOperator. Consider upgrading to EnhancedKafkaPublisherOperator")
